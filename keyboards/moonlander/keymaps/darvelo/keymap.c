...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        _______, KC_PERC,  KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD,                                       KC_AMPR, KC_1,    KC_2,    KC_3,    KC_BSLS, KC_BRID,
        _______, KC_COMMA, _______, _______, _______,          RGB_MOD,                     RGB_TOG,          _______, KC_DOT,  KC_0,    KC_EQL,  _______,
